...
export default function Teams() {
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="my-5 flex w-96 flex-col mx-auto rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
        <div className="mx-4 mt-4 h-80 overflow-hidden rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
