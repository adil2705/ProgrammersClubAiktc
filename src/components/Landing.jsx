    ...
    <div className="mx-auto mb-5 grid max-w-7xl px-4 sm:px-6 md:mt-2 lg:grid-cols-2 lg:px-4 2xl:grid-cols-2">
      <div className="mx-auto max-w-md px-8 py-4 sm:max-w-xl lg:max-w-full lg:px-12 lg:py-12 xl:mr-0 2xl:col-span-5">
        <div className="xl:max-w-xl">
          ...
          {/* button  */}
        <a href="https://algorithm8.aiktc.ac.in/" class="relative inline-block text-lg group">
<span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-orange-900 rounded-lg group-hover:text-white">
